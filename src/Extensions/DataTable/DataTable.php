...
namespace VulcanPhp\PhpAdmin\Extensions\DataTable;

use PDO;
use VulcanPhp\PhpAdmin\Extensions\DataTable\Traits\DataTableDB;
use VulcanPhp\PhpAdmin\Extensions\DataTable\Traits\DataTableModules;

class DataTable
{
    use DataTableDB, DataTableModules;
    ...
    public static function model(...$args): DataTable
    {
